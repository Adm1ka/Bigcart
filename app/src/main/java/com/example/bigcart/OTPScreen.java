...
public class OTPScreen extends AppCompatActivity{
    ...
    private void setupKeyListeners() {
        editText1.setOnKeyListener(new GenericKeyListener(null, editText2));
        editText2.setOnKeyListener(new GenericKeyListener(editText1, editText3));
        editText3.setOnKeyListener(new GenericKeyListener(editText2, editText4));
        editText4.setOnKeyListener(new GenericKeyListener(editText3, editText5));
        editText5.setOnKeyListener(new GenericKeyListener(editText4, editText6));
        editText6.setOnKeyListener(new GenericKeyListener(editText5, null));
    }
