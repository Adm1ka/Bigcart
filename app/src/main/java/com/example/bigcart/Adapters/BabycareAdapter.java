...
public class BabycareAdapter extends RecyclerView.Adapter<BabycareAdapter.ViewHolder>{
    ...
    public BabycareAdapter(Context context, List<Product> productList) {
        this.context = context;
        this.productList = productList;
    }
    @NonNull
    @Override
    public BabycareAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.product_item, parent, false);
        return new BabycareAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull BabycareAdapter.ViewHolder holder, int position) {
