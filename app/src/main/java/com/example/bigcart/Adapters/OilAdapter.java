...
public class OilAdapter extends RecyclerView.Adapter<OilAdapter.ViewHolder>{
    ...
    public OilAdapter(Context context, List<Product> productList) {
        this.context = context;
        this.productList = productList;
    }
    @NonNull
    @Override
    public OilAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.product_item, parent, false);
        return new OilAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull OilAdapter.ViewHolder holder, int position) {
